  ...
  return (
    <DynamicBackground>
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('/abstract-green-bg.svg')] bg-cover bg-center opacity-20"></div>
            ...
            <div className="max-w-3xl mx-auto text-center space-y-8 fade-in">
              ...
              <div className="mt-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
                {[
                  ...
                  <div 
                    key={index} 
                    className="card-hover bg-white p-8 rounded-xl shadow-soft scale-in flex flex-col justify-center w-full" 
                    style={{
